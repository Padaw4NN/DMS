...
public class viewDataDispositive1 extends AppCompatActivity {

        private DatabaseReference reference = FirebaseDatabase.getInstance().getReference();
        private DatabaseReference referenceSensors = reference.child("N");
        private ListView listDispositive1;
        private ArrayList<String> dataSensors;
        public ArrayList<Float> valueArray = new ArrayList<>();


    public viewDataDispositive1() {
        }

        Query sensorsListQuery = referenceSensors.orderByChild("N");
